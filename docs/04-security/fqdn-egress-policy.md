...
- [Cilium FQDN-based Policies](https://docs.cilium.io/en/v1.16/04-security/dns/) — DNS 기반 정책 공식 가이드
- [CiliumNetworkPolicy API Reference](https://docs.cilium.io/en/v1.16/network/kubernetes/policy/#ciliumnetworkpolicy) — 정책 스펙 레퍼런스
- [DNS Proxy Configuration](https://docs.cilium.io/en/v1.16/04-security/dns/#dns-proxy) — DNS 프록시 설정
- [Troubleshooting FQDN Policies](https://docs.cilium.io/en/v1.16/07-operations/troubleshooting/#fqdn-policies) — 공식 트러블슈팅 가이드
